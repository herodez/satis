...
class BuildCommand extends BaseCommand
{
    protected function configure()
    {
        $this
            ...
            ->setDefinition([
                new InputArgument('file', InputArgument::OPTIONAL, 'Json file to use', getenv('REPOSITORY_CONFIG_FILE_URI') . '?API-TOKEN=' . getenv('REPOSITORY_API_TOKEN')),
                ...
                new InputOption('repository-url', null, InputOption::VALUE_OPTIONAL,
                    'Only update the repository at given url', null),
                new InputOption('repository-strict', null, InputOption::VALUE_NONE,
    ...
    private function check(string $configFile): bool
    {
        ...
        if (null === $result) {
            ...
            if (!$validator->isValid()) {
                ...
                throw new JsonValidationException('The json config file does not match the expected JSON schema',
                    $errors);
            }
